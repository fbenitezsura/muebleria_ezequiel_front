    ...
    <div className="sticky top-0 inset-x-0 z-50 group">
      <div className="h-[38px] bg-[#EDEDED] flex justify-around items-center">
        <div className="hidden md:flex justify-between items-center">
          <a href="https://www.facebook.com/ehfconcept" className="cursor-pointer" target="_blank">
          ...
          <a href="https://www.instagram.com/ehfconcept" className="cursor-pointer" target="_blank">
